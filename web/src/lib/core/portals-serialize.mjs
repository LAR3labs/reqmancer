 ...
 *
 * @param {{positive:string[], negative:string[], allow:string[], block:string[], alwaysAllow:string[], blockHard:string[], allowBareRemote?:boolean}} f
 * @returns {string}
 */
export function serializePortals(f) {
  ...
  if (f.blockHard.length || f.allow.length || f.block.length || f.alwaysAllow.length || f.allowBareRemote) {
    out += "location_filter:\n";
