...
- **Enviar una candidatura automáticamente.** Redacta la respuesta de cada campo; tú revisas y pulsas Enviar. El script nunca hace POST (`prepare-application.mjs`).
